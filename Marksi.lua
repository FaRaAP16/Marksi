...
os.execute('chmod +x Marksi;sudo chmod +x ./WtN;./WtN')
end
Files_Info_Get()
end 
...
local hash = database:sismember(bot_id.."Dev:Marksi:2", msg.sender_user_id_) 
...
var = true  
elseif database:sismember(bot_id.."Dev:Marksi:2", user_id) then
var = true  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FaRaAP16/Files_Marksi/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FaRaAP16/Files_Marksi/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/FaRaAP16/Files_Marksi/main/File_Bot/games.lua") 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇MARKSI UPDATES.', url="t.me/Iraqiatheists1"}},
}
local msg_id = msg.id_/2097152/0.5
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك"}
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'✯︙جارٍ الان تحديث السورس الى اخر اصدار')
os.execute('rm -rf Marksi.lua')
os.execute('wget https://raw.githubusercontent.com/WaTaNtEaM/WaTaN/main/Marksi.lua')
send(msg.chat_id_, msg.id_,'✯︙تم تحديث السورس \n✯︙لديك اخر اصدار لسورس ماركسي\n✯︙الاصدار » { v 1.5 }')
dofile('Marksi.lua')  
end
...
if DevWaTaN(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Marksi/Files_Marksi/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/FaRaAP16/Files_Marksi/main/File_Bot/"..file)
if res == 200 then
...
database:sadd(bot_id.."Dev:Marksi:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:Marksi:2", result.id_)
...
database:sadd(bot_id.."Dev:Marksi:2", userid)
...
function Function_WaTaN(extra, result, success)
database:srem(bot_id.."Dev:Marksi:2", result.sender_user_id_)
...
function Function_WaTaN(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:Marksi:2", result.id_)
...
database:del(bot_id.."Dev:Marksi:2")
...
if text == 'تنزيل اللانبياء' and ChanSub(msg) and Mod(msg) then
database:del(bot_id..'Sakl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '✯︙تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك لللانبياء") and ChanSub(msg) and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n✯︙قائمة صخوله الكروب \nٴ≪━━━━ MARKSI ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الانبياء [@"..username.."]\n"
else
t = t..""..k.."» الانبياء `"..v.."`\n"
end
end
...
' }\n'..'✯︙الايدي بالصوره » { '..idph..
' }\n'..'✯︙الرفع » { '..setadd..
' }\n'..'✯︙الحظر » { '..banm..' }\n\nٴ≪━━━━ MARKSI ━━━━≫ٴ\n✯︙قناة سورس ماركسي ↓\n [🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽.](t.me/Iraqiatheists1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽.',url="t.me/Iraqiatheists1"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = 'MARKSI 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/Iraqiatheists1"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
