...
screen -S Marksi ./Marksi
done
]])
RunWtN:close()
io.popen("mkdir File_Bot") 
os.execute('chmod +x WaTaN;sudo chmod +x ./Mark;./Mark')
end
Files_Info_Get()
end 
...
local UserName = (data.username_ or "Iraqiatheists1")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 MARKSI.")  
...
if File_Name ~= "Marksi.lua" then 
send(chat,msg.id_," **︙هذا الملف غير تابع لسورس ماركسي")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
...
if data.Ch_Member.Info_Iraqiatheists1 ~= true then
...
{{text = 'مطـور البـوت',url="t.me/"..result.username_ or Iraqiatheists1},
{text = 'قناة السورس',url="t.me/Iraqiatheists1"}},
{{text = 'لتنصـيب بـوت',url="https://t.me/Fa_RaAP"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
...
os.execute('rm -rf Marksi.lua')
os.execute('wget https://raw.githubusercontent.com/FaRaAP16/Marksi/main/Marksi.lua')
send(msg.chat_id_, msg.id_,'**︙تم تحديث السورس \n**︙لديك اخر اصدار لسورس ماركسي\n**︙الاصدار » { v 3.2 }')
dofile('Marksi.lua')  
end

if text == 'مطور السورس **' and DevWaTaN(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'**︙اهلا بك عزيزي\n**︙ان كان لديك استفسار او اي مشكلة\n**︙يمكنك مراسلة مطور السورس\n**︙حساب مطور السورس [اضـغـط هـنـا  𓆩•𝐀𝐁𝐁𝐀𝐒 𝐅𝐀𝐃𝐇𝐈𝐋•𓆪  ](t.me/Fa_RaAP)')
end
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './Marksi.lua', '**︙نسخة ملف سورس ماركسي')
end 
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'**︙اصدار سورس ماركسي \n**︙الاصدار »{ v 3.2 }')
end
...
*تحديثات وشروحات سورس ماركسي*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/Iraqiatheists1"}},
}
local msg_id = msg.id_/2097152/0.5
...
usertext = '\n**︙العضو » ['..result.title_..'](t.me/'..(username or 'Iraqiatheists1')..')'
status  = '\n**︙تم ترقيته مطور'
...
usertext = '\n**︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
status  = '\n**︙تم ترقيته مطور'
...
if WaTaN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'**︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Iraqiatheists1')..') \n**︙'..WaTaN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," **︙العضو : {["..data.first_name_.."](t.me/Iraqiatheists1)}\n**︙["..WaTaN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " **︙عذرا » {["..data.first_name_.."](t.me/Iraqiatheists1)}\n**︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:setex(bot_id..'database4'..msg.sender_user_id_,360,true)
send(msg.chat_id_, msg.id_,"**︙اهلا عزيزي المطور \n**︙ارفع البوت مشرف في قناتك \n**︙ثم ارسل معرف قناتك\n**︙مثال على معرف القناة @Iraqiatheists1")
end
end
return false  
end
...
Text = "**︙اهلا بك عزيزي \n**︙عليك اضافة هذا البوت @kg7bot الى مجموعتك\n**︙ثم رفعه مشرفا ثم اتبع الاوامر التاليه [هـنـا](https://t.me/Iraqiatheists1/6499)"
keyboard = {} 
keyboard.inline_keyboard = {
...
Text = "[⦑ Welcome to Source ⦒](t.me/Iraqiatheists1)\n[** ⦑ SOURCE WaTaN ⦒](t.me/Iraqiatheists1)\n** Source version : 3.2"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/Iraqiatheists1"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/watanupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/Iraqiatheists1/7"},
{text = '𝒘𝒂𝒕𝒂𝒏 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/Fa_RaAP"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Iraqiatheists1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './File_Bot/Reply.lua', '**︙ملف الردود الخاص بسورس ماركسي')
end 
end
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './File_Bot/games.lua', '**︙ملف الالعاب الخاص بسورس ماركسي')
end 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'**︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Iraqiatheists1')..') \n**︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'**︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Iraqiatheists1')..') \n**︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n**︙اهلا بك في متجر ملفات ماركسي\n**︙ملفات السورس ↓\nٴ≪━━━━ MARKSI ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ MARKSI ━━━━≫ٴ\n**︙علامة تعني { ✔️ } ملف مفعل\n**︙علامة تعني { ✖ } ملف معطل\n**︙قناة سورس ماركسي ↓\n".." **︙[اضغط هنا لدخول](t.me/Iraqiatheists1) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," **︙عذرا الملف لايدعم سورس ماركسي \n") 
end
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or Iraqiatheists1}}}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n**︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
status  = '\n**︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n**︙العضو » '..userid..''
...
if text == ("رفع الله") and ChanSub(msg) and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'**︙تم تعطيل الرفع') 
return false
end
...
if (text == ("تنزيل الله")) and ChanSub(msg) and msg.reply_to_message_id_ and Mod(msg) then
function start_function(extra, result, success)
database:srem(bot_id..'Mote:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n**︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
status  = '\n**︙تم تنزيل العضو الله في الكروب\n**︙تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n**︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
...
if text == 'تنزيل االانبياء' and ChanSub(msg) and Mod(msg) then
database:del(bot_id..'Sakl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '**︙تم تنزيل جميع صخوله من الكروب')
end
if text == ("تاك لالانبياء") and ChanSub(msg) and Mod(msg) then
...
if text == ("رفع نبي") and ChanSub(msg) and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'**︙تم تعطيل الرفع') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n**︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
local  statuss  = '\n**︙تم رفع المتهم نبي بالكروب\n**︙الان اصبح نبي الكروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل نبي")) and ChanSub(msg) and msg.reply_to_message_id_ and Mod(msg) then
function start_function(extra, result, success)
...
if text == 'تنزيل اللائمة' and ChanSub(msg) and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '**︙تم تنزيل جميع اللائمة بالكروب')
end
if text == ("تاك لللائمة") and ChanSub(msg) and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n**︙قائمة اللائمة الكروب \nٴ≪━━━━ MARKSI ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الامام [@"..username.."]\n"
else
t = t..""..k.."» الامام `"..v.."`\n"
end
end
...
if text == ("رفع امام") and ChanSub(msg) and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'**︙تم تعطيل الرفع') 
return false
end
...
if (text == ("تنزيل امام")) and ChanSub(msg) and msg.reply_to_message_id_ and Mod(msg) then
function start_function(extra, result, success)
database:srem(bot_id..'Motee:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n**︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
status  = '\n**︙تم تنزيل امام من الكروب\n**︙رجع موزه حبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == 'تنزيل اللملائكة' and Mod(msg) then
database:del(bot_id..'Bakra:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '**︙تم تنزيل جميع اللملائكة بالكروب')
end
if text == ("تاك لللملائكة") and ChanSub(msg) and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n**︙قائمة اللملائكة الكروب \nٴ≪━━━━ MARKSI ━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الملك [@"..username.."]\n"
else
t = t..""..k.."» الملك "..v.."\n"
end
end
...
if text == ("رفع ملك") and ChanSub(msg) and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'**︙تم تعطيل الرفع') 
return false
end
...
if (text == ("تنزيل ملك")) and ChanSub(msg) and msg.reply_to_message_id_ and Mod(msg) then
function start_function(extra, result, success)
database:srem(bot_id..'Bakra:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n**︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
status  = '\n**︙تم تنزيل ملك من الكروب\n**︙تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
' }\n'..'**︙الايدي بالصوره » { '..idph..
' }\n'..'**︙الرفع » { '..setadd..
' }\n'..'**︙الحظر » { '..banm..' }\n\nٴ≪━━━━ MARKSI ━━━━≫ٴ\n**︙قناة سورس ماركسي ↓\n [🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 MARKSI.](t.me/Iraqiatheists1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or Iraqiatheists1}},
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/Iraqiatheists1"}},
}
local msg_id = msg.id_/2097152/0.5
...
Text = [[
  **︙[DeVeLoPErE OF SoURcE](https://t.me/Fa_RaAP)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '**︙DeVeLoPErE OF SoURcE',url="t.me/Fa_RaAP"}},
{{text = '**︙ChAnNeL OF SoURcE',url="t.me/Iraqiatheists1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Iraqiatheists1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[**︙ChAnNeL OF SoURcE](https://t.me/Iraqiatheists1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '**︙ChAnNeL OF SoURcE',url="t.me/Iraqiatheists1"}},
...
{{text = 'WaTaN TeaM .', url="t.me/Iraqiatheists1"}},
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n**︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Iraqiatheists1')..')'..'\n**︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماركسي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ماركسي')
local WaTaN_Msg = {
'عمغي 🥺💕.',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 MARKSI.',url="t.me/Iraqiatheists1"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."Iraqiatheists1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"**︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and ChanSub(msg) and Manager(msg) then 
database:del(bot_id.."Iraqiatheists1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Iraqiatheists1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماركسي').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Iraqiatheists1')..')'
local iduser = result.sender_user_id_
...
{
{text = 'MARKSI CHANNEL', url="t.me/Iraqiatheists1"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ MARKSI ━━━━≫ٴٴ\n**︙➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 MARKSI. ](t.me/Iraqiatheists1)➤ ')
end
...
{
{text = 'MARKSI 𝐂??𝐀𝐍𝐍𝐄𝐋', url="t.me/Iraqiatheists1"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ماركسي')
